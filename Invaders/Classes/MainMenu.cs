...
public class MainMenu : Entity
{
    ...
    public MainMenu() : base("Title")
    {
        ...
        HighScoreButton = new Buttons("NewGameButton", new Vector2f(40, 250));
        NewGameButton = new Buttons("HighScoresButton", new Vector2f(40, 400));
        QuitButton = new Buttons("QuitButton", new Vector2f(40, 550));
    }
